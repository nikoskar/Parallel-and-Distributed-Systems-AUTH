...
int main(int argc, char *argv[])
{
    ...
    /* Reserve memory for the CSC column and the CSC row matrices        */
    /* We dont mind about the val array in v3 since its filled with ones */
    ...
    /* Reserve memory and initialize c3 (triangles per node array) */
    ...
    for(uint32_t j = 0; j < N - 1; j++) {
      ...
      /* Add the indexes of the nonzero elements of j, in log */
