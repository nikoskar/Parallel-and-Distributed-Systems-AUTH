...
int main(int argc, char *argv[])
{
    ...
    cilk_for(uint32_t i = 0; i < N; i++) {
      ...
      // adding a cilk for here will increase the overhead and total execution time
      // for small datasets but it scales better than a simple for
      cilk_for(uint32_t j = 0; j < endi - starti; j++) {
    ...
    // we tested using a cilk_for here, it increased the execution time.
    for(uint32_t i = 0; i < N; i++)
    {
